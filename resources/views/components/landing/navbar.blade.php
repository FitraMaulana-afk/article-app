<nav class="top-0 py-10 px-10 md:px-32 " x-data="dropdown()">
    ...
    <div class="flex w-full justify-between items-center ">
        ...
        <div class="flex lg:hidden">
            <div x-data>
                <button x-bind:class="{ 'bg-gray-700': open, 'text-white': open }"
                    class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-white hover:bg-gray-700 focus:outline-none focus:bg-gray-700 focus:text-white transition duration-150 ease-in-out"
                    aria-controls="mobile-menu" aria-expanded="false">Click</button>
            </div>
        </div>
    ...
    <div class="hidden lg:flex my-6 bg-orange-500 py-2 px-4 rounded-sm shadow-md text-white">
        <ul class="flex justify-between items-center text-center w-full">
