<nav aria-label="secondary" x-data="{ open: false }"
    ...
    <div class="flex items-center gap-3">
        ...
        <x-dropdown align="right" width="48">
            <x-slot name="trigger">
                <button
                    class="flex items-center p-2 text-sm font-medium text-white rounded-md transition duration-150 ease-in-out hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-200">
